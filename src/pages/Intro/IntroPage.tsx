...
const IntroPage = () => {
  ...
  return (
    <S.Wrapper>
      <S.Section>
        <S.Image src="src/assets/images/img_landing.png" alt="팔굽평 예시" />
      ...
      <PlanCard
        ...
        src="src/assets/images/img_rotary_dial.gif"
      />

      <PlanCard
        point="Point 02"
        title="통계 그래프로 확인하는 성장"
        src="src/assets/images/img_records.png"
        $imgPosition="left"
      />
